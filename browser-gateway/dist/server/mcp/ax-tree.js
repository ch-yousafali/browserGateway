...
export async function getSnapshot(cdp) {
    clearRefs();
    try {
 ...
 */
async function withResolvedRef(cdp, ref, action) {
...
export function clickByRef(cdp, ref) {
    return withResolvedRef(cdp, ref, (objectId) => cdp.send("Runtime.callFunctionOn", {
        objectId,
        functionDeclaration: `function() { this.scrollIntoView({ block: 'center' }); this.click(); }`,
    }));
}
export function typeByRef(cdp, ref, text, clear = true) {
    return withResolvedRef(cdp, ref, (objectId) => cdp.send("Runtime.callFunctionOn", {
        objectId,
...
//# sourceMappingURL=ax-tree.js.map