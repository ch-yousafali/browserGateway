...
import { GatewayConfigSchema } from "../../core/types.js";
...
export let loadedConfigPath = null;
/**
 ...
 */
function defaultWritableConfigPath() {
...
function validateProfileEligibility(config) {
    ...
    if (!hasMultiProfile && !hasPinned) {
        console.warn("profiles.enabled is true but no provider statically declares profile capability.\n" +
