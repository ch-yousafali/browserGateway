...
export function deriveKek(password, params) {
    if (!password || password.length < MIN_PASSWORD_LENGTH) {
        throw new Error(`BG_ENCRYPTION_KEY must be at least ${MIN_PASSWORD_LENGTH} characters of high-entropy input (e.g., base64-encoded 32 random bytes)`);
    }
