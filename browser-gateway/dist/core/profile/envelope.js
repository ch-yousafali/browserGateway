...
export function wrapDek(kek, dek, version) {
...
export function unwrapDek(kek, wrapped) {
    return aeadDecrypt(kek, Buffer.from(wrapped.ivB64, "base64"), Buffer.from(wrapped.wrappedB64, "base64"), Buffer.from(wrapped.tagB64, "base64"), DEK_WRAP_AAD);
}
