 ...
 */
export async function extractWithDefuddle(rawHtml, pageUrl, markdown) {
...
export function metadataFromDefuddle(result) {
    return {
        title: result.title,
 ...
 */
export async function extractFormats(rawHtml, pageUrl, innerText, formats) {
    const content = {};
    let metadata;
