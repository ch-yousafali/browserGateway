 ...
 */
export function computePriorityEffect(priority, siblingPriorities) {
    ...
    const siblingLabel = tiedCount > 1
 ...
 */
export function computeWeightEffect(priority, weight, siblings) {
